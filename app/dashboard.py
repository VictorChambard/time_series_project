...
from models.forecast import (
    estimer_var, estimer_vecm, choisir_modele, preparer_rendements_log_mensuels,
...
if st.button("Lancer la prévision"):
    if model_choice == "Auto (choix basé sur les tests)":
        ...
        st.write(f"Modèle sélectionné automatiquement : **{selected_model}**")
    else:
